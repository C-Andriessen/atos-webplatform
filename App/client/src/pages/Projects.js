...
const posts = [
  {
    title: "Hulp nodig met het regelen van mijn boekhouding",
    href: "#",
    category: { name: "Financiën", href: "#" },
    description:
  ...
  {
    title: "Portfolio website nodig",
    href: "#",
    category: { name: "Software", href: "#" },
    description:
  ...
  {
    title: "Ik heb een logo nodig voor mijn website",
    href: "#",
    category: { name: "Designer", href: "#" },
    description:
  ...
  {
    title: "Huis inrichten",
    href: "#",
    category: { name: "Binnenhuis architect", href: "#" },
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint harum rerum voluptatem quo recusandae magni placeat saepe molestiae, sed excepturi cumque corporis perferendis hic.",
    date: "Feb 12, 2020",
    datetime: "2020-02-12",
